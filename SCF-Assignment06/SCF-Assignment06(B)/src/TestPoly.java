...
public class TestPoly {
	...
	public static class ParameterizedTestsForEvaluate {
		...
		public static Collection<Object[]> input() {
			return Arrays.asList(new Object[][]{
					{
						new Poly(new int[][]{{2, 2},{3, 0}}),1,5
					},
					{
						new Poly(new int[][]{{2, 2},{3, 2}}),2,20
					},
					{
						new Poly(new int[][]{{3, 0}, {5, 1},{1, 3}}),5.5f,196.875
					},
					{
						new Poly(new int[][]{{0, 1}, {2, 2}}),3,18
					}
			});
		}
	...
	public static class ParameterizedTestsForDegree {
		...
		public static Collection<Object[]> input() {
			return Arrays.asList(new Object[][]{
					{
						new Poly(new int[][]{{1, 2},{2, 2}}),2
					},
					{
						new Poly(new int[][]{}),0
					},
					{
						new Poly(new int[][]{{1, 3},{2, 5}}),5
					}
			});
		}
	...
	public static class ParameterizedTestsForAddPoly {
		...
		public static Collection<Object[]> input() {
			return Arrays.asList(new Object[][]{
					{
						new Poly(new int[][] {{1, 3},{2, 2}}),
						new Poly(new int[][]{{2, 3},{1, 1}}),
						new Poly(new int[][]{{2, 2},{1, 1},{3, 3}})
					},
					{
						new Poly(new int[][]{{3, 0},{1, 1}}),
						new Poly(new int[][]{{8, 3},{2, 2}}),
						new Poly(new int[][]{{3, 0},{1, 1},{8, 3},{2, 2}})
					}
			});
		}
	...
	public static class ParameterizedTestsForMultiplyPoly {
		...
		public static Collection<Object[]> input() {
			return Arrays.asList(new Object[][] {
					{
						new Poly(new int[][]{{1, 0},{2, 1},{3, 2},}),
						new Poly(new int[][]{{2, 1},{4, 4}}),
						new Poly(new int[][]{{2, 1},{4, 2},{6, 3},{4, 4},{8, 5},{12, 6}}),
					},
					{
						new Poly(new int[][] {{1, 0},{1, 1}}),
						new Poly(new int[][] {{2, 1},{1, 2}}),
						new Poly(new int[][] {{2, 1},{3, 2},{1, 3}})
					}
			});
		}
	...
	public static class ParameterizedTestsForEquals {
		...
		public static Collection<Object[]> input() {
			return Arrays.asList(new Object[][] {
					{
						new Poly(new int[][]{{1,2},{2,0},{3,2},{4,3}}),
						new Poly(new int[][]{{2,0},{4,2},{4,3}}),
						true
					},
					{
						new Poly(new int[][]{{1,2},{2,0},{3,2},{4,3}}),
						new Poly(new int[][]{{2,0},{4,2},{0,2},{4,3}}),
						true
					},
					{
						new Poly(new int[][]{{2,0},{5,2},{4,3}}),
						new Poly(new int[][]{{2,0},{4,2},{4,3}}),
						false
					}
			});
