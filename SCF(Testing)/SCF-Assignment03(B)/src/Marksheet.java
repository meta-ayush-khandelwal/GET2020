...
public class Marksheet {
	 ...
	 */
	public static float[] getGrades(int noOfStudents)throws ArithmeticException{
	 ...
	 */
	public static float gradeAverage(float grades[])throws ArithmeticException{
		if(grades.length==0)
	 ...
	 */
	public static float[] minMaxGrade(float grades[])throws ArithmeticException{
		if(grades.length==0)
			throw new ArithmeticException();
		float minMax[]={101,0};
		for(int loop=0;loop<grades.length;loop++){
	 ...
	 */
	public static float passStudentsPercentage(float grades[])throws ArithmeticException{
		if(grades.length==0)
			throw new ArithmeticException();
		int passStudents=0;
		for(int loop=0;loop<grades.length;loop++){
